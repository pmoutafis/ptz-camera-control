...
def send_uvcc_config(config_dict):
    ...
    try:
        ...
        subprocess.run(["uvcc", "import"], input=json_bytes, check=True, timeout=2)
...
def ptz():
    ...
    # Reject rapid spam clicks while hardware is physically moving
    ...
    try:
        ...
        if system_os == "Darwin":
            ...
            if z != 0:
                # Scaled zoom increment (100 to 1000 range)
